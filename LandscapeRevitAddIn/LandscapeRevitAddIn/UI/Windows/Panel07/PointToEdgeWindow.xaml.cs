...
{
    public partial class PointToEdgeWindow : Window
    {
        ...
        public PointToEdgeWindow(UIDocument uiDoc)
        {
            InitializeComponent();
            _uiDoc = uiDoc;
            _doc = uiDoc.Document;
        ...
        private void CreateLogoPlaceholder()
        {
            try
            {
                ...
                {
                    // Fixed: Use System.Windows.Media.Color explicitly
        ...
        {
            // Fixed: Use System.Windows.Media.Color explicitly for all color references
    ...
    public class FloorPointSelectionFilter : ISelectionFilter
    {
